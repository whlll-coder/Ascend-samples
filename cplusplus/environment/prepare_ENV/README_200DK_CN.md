...
5.  在开发环境部署Media模块  
    1.  将[A200dk-npu-driver-{software version}-ubuntu18.04-aarch64-minirc.tar.gz](https://support.huaweicloud.com/environment-deployment-Atlas200DK1010/atlased_04_0027.html)以开发环境安装用户上传到\$HOME/Ascend目录下。  
    2.  解压driver包   
         **cd \$HOME/Ascend**    
