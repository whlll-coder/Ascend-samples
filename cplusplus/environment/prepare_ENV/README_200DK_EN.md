...
5. Deploying the Media Module.  
    1.  Upload [A200dk-npu-driver-{software version}-ubuntu18.04-aarch64-minirc.tar.gz](https://www.hiascend.com/hardware/firmware-drivers?tag=community) to the \$HOME/Ascend directory.    
