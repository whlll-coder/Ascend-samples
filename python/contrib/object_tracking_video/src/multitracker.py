...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        # id_feature: n * 128, where 128 is id feature vector size
        dets, id_feature = mot_decode(hm, wh, reg, id_feature, conf_thres=self.opt.conf_thres)
        ...
        if len(dets) > 0:
            ...
            detections = [STrack(STrack.tlbr_to_tlwh(tlbrs[:4]), tlbrs[4], f, 30)
