...
def model_fn(features, labels, mode, params):
    ...
    # Decompose graph after building model and before building optimizer
    decompose_graph(params['save_path'])
...
def main():
    ...
    # Build estimator, load the decomposed ckpt file for finetuning
    estimator = tf.estimator.Estimator(
        model_fn,
        warm_start_from=save_path,
        params={
            'save_path': save_path,
            'ckpt_path': ckpt_path,
