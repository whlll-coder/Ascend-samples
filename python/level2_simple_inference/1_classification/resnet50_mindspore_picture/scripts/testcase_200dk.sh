...
data_source="https://c7xcode.obs.cn-north-4.myhuaweicloud.com/models/resnet50_mindspore/airplane.jpg"
verify_source="https://c7xcode.obs.cn-north-4.myhuaweicloud.com/models/resnet50_mindspore/airplane_verify.jpg"
...
function setRunEnv() {
    ...
    if [[ ${version} = "c76" ]] || [[ ${version} = "C76" ]];then
        export LD_LIBRARY_PATH=/home/HwHiAiUser/Ascend/acllib/lib64:/home/HwHiAiUser/Ascend/ascend-toolkit/latest/atc/lib64:/home/HwHiAiUser/ascend_ddk/arm/lib:${LD_LIBRARY_PATH}
