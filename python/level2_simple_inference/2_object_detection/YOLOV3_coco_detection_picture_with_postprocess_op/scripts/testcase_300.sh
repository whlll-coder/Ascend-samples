...
function main() {
    ...
    export LD_LIBRARY_PATH=/usr/local/Ascend/nnrt/latest/acllib/lib64:/usr/local/Ascend/ascend-toolkit/latest/atc/lib64:/usr/local/ascend_ddk/x86/lib:${LD_LIBRARY_PATH}
    export PYTHONPATH=/usr/local/Ascend/nnrt/latest/pyACL/python/site-packages/acl:${PYTHONPATH}
